...
def solve(y, A_fun, AT_fun, denoiser, reshape_img_fun, base_folder, show_img_progress=False, alpha=0.2, max_iter=100, solver_tol=1e-6, ori_img=None):
    ...
    for iter in range(max_iter):
        ...
        # x-update
        # just applies the learned projection...
        net_input = z+u
