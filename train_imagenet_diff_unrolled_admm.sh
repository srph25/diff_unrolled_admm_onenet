...
TRIAL=1
PRETRAIN_RECON=0
BATCH_SIZE=5  # reference batch included
N_REFERENCE=0
DPERIOD=0
GPERIOD=1
...
python3.7 -u train.py \
    ...
    --use_elu_like $USE_ELU_LIKE\
    --use_custom_image_resize $USE_CUSTOM_IMAGE_RESIZE\
    --use_diff_admm $USE_DIFF_ADMM\
    --gpus $GPUS\
