...
#pretrained_folder = os.path.expanduser("../projector/model/imsize64_ratio0.010000_dis0.005000_latent0.000100_img0.001000_de1.000000_derate1.000000_dp1_gd1_softpos0.850000_wdcy_0.000001_seed0")
#iter = 49999
#iter = 9999
#iter = 23999
#pretrained_folder = os.path.expanduser("../projector/model_celeb/imsize64_ratio0.010000_dis0.005000_latent0.000100_img0.001000_de1.000000_derate1.000000_dp1_gd1_softpos0.850000_wdcy_0.000000_seed0")
#iter = 7999 # 1999
iter = 233999 # 1999
pretrained_folder = os.path.expanduser("../projector/model/imsize64_ratio0.010000_dis0.005000_latent0.000100_img0.001000_de1.000000_derate1.000000_dp5_gd1_softpos0.850000_wdcy_0.000000_seed0")
#pretrained_folder = os.path.expanduser("../projector/model/imsize64_ratio0.010000_dis0.005000_latent0.000100_img0.001000_de1.000000_derate1.000000_dp5_gd1_softpos0.850000_wdcy_0.000000_seed0")
#pretrained_folder = os.path.expanduser("../projector/model/imsize64_ratio0.010000_dis0.005000_latent0.000100_img0.001000_de1.000000_derate1.000000_dp1_gd1_softpos0.850000_wdcy_0.000000_seed0")
...
#ref_file = '%s/ref_batch_1.mat' % pretrained_folder
...
if use_latent > 0:
    _,_,_,_,_, = sess.run([proj_update, latent_update, dis_update, dis_latent_update, updates],
                      feed_dict={images_tf: ref_batch})
else:
    _,_,_,_, = sess.run([proj_update, latent_update, dis_update, updates],
            feed_dict={images_tf: ref_batch})
